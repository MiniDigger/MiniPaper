...
public class CraftItemFrame extends CraftHanging implements ItemFrame {
    ...
    private void update() {
        net.minecraft.world.entity.decoration.ItemFrame old = this.getHandle();
        ...
        net.minecraft.world.entity.decoration.ItemFrame frame = new net.minecraft.world.entity.decoration.ItemFrame(world, position, direction);
        frame.setItem(item);
