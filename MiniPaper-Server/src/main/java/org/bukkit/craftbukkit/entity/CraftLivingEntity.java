...
public class CraftLivingEntity extends CraftEntity implements LivingEntity {
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
        ...
        if (Snowball.class.isAssignableFrom(projectile)) {
            ...
            ((ThrowableProjectile) launch).shootFromRotation(getHandle(), getHandle().xRot, getHandle().yRot, 0.0F, 1.5F, 1.0F); // ItemSnowball
        } else if (Egg.class.isAssignableFrom(projectile)) {
            launch = new ThrownEgg(world, getHandle());
            ((ThrowableProjectile) launch).shootFromRotation(getHandle(), getHandle().xRot, getHandle().yRot, 0.0F, 1.5F, 1.0F); // ItemEgg
        } else if (EnderPearl.class.isAssignableFrom(projectile)) {
            launch = new ThrownEnderpearl(world, getHandle());
            ((ThrowableProjectile) launch).shootFromRotation(getHandle(), getHandle().xRot, getHandle().yRot, 0.0F, 1.5F, 1.0F); // ItemEnderPearl
            ...
            ((net.minecraft.world.entity.projectile.AbstractArrow) launch).shootFromRotation(getHandle(), getHandle().xRot, getHandle().yRot, 0.0F, 3.0F, 1.0F); // ItemBow
            ...
            ((ThrowableProjectile) launch).shootFromRotation(getHandle(), getHandle().xRot, getHandle().yRot, -20.0F, 0.5F, 1.0F); // ItemSplashPotion
        } else if (ThrownExpBottle.class.isAssignableFrom(projectile)) {
            launch = new ThrownExperienceBottle(world, getHandle());
            ((ThrowableProjectile) launch).shootFromRotation(getHandle(), getHandle().xRot, getHandle().yRot, -20.0F, 0.7F, 1.0F); // ItemExpBottle
            ...
            if (SmallFireball.class.isAssignableFrom(projectile)) {
                ...
                launch = new LargeFireball(world, getHandle(), direction.getX(), direction.getY(), direction.getZ());
            }
    ...
    public boolean setLeashHolder(Entity holder) {
        if ((getHandle() instanceof WitherBoss) || !(getHandle() instanceof Mob)) {
            return false;
        }
