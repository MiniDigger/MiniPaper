...
public class CraftInventoryPlayer extends CraftInventory implements org.bukkit.inventory.PlayerInventory, EntityEquipment {
    ...
    public void setItem(int index, ItemStack item) {
        ...
        player.connection.sendPacket(new ClientboundContainerSetSlotPacket(player.inventoryMenu.containerId, index, CraftItemStack.asNMSCopy(item)));
    }
    ...
    public void setHeldItemSlot(int slot) {
        ...
        ((CraftPlayer) this.getHolder()).getHandle().connection.sendPacket(new ClientboundSetCarriedItemPacket(slot));
    }
