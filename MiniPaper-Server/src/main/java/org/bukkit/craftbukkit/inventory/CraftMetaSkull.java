...
class CraftMetaSkull extends CraftMetaItem implements SkullMeta {
    ...
    void deserializeInternal(CompoundTag tag, Object context) {
        ...
        if (tag.contains(SKULL_PROFILE.NBT, CraftMagicNumbers.NBT.TAG_COMPOUND)) {
            this.setProfile(NbtUtils.readGameProfile(tag.getCompound(SKULL_PROFILE.NBT)));
        }
    }
    ...
    void applyToItem(CompoundTag tag) {
        ...
        if (profile != null) {
            ...
            setProfile(com.google.common.util.concurrent.Futures.getUnchecked(SkullBlockEntity.b(profile, com.google.common.base.Predicates.alwaysTrue(), true))); // Spigot
