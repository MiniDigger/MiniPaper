...
public class CraftMetaBook extends CraftMetaItem implements BookMeta {
    ...
    public List<Component> pages = new ArrayList<Component>();
        ...
        if (handlePages) {
            if (hasPages()) {
                ...
                for (Component page : pages) {
                    list.add(StringTag.valueOf(page == null ? "" : CraftChatMessage.fromComponent(page)));
                }
    ...
    public CraftMetaBook clone() {
        ...
        meta.pages = new ArrayList<Component>(pages);
        return meta;
    }
    ...
    private final BookMeta.Spigot spigot = new BookMeta.Spigot() {
        ...
        public BaseComponent[] getPage(final int page) {
            Validate.isTrue(isValidPage(page), "Invalid page number");
            return ComponentSerializer.parse(Component.ChatSerializer.a(pages.get(page - 1)));
        }
        ...
        public void setPage(final int page, final BaseComponent... text) {
            ...
            CraftMetaBook.this.pages.set(page - 1, Component.ChatSerializer.a(ComponentSerializer.toString(newText)));
        }
        ...
        public void addPage(final BaseComponent[]... pages) {
            for (BaseComponent[] page : pages) {
                ...
                CraftMetaBook.this.pages.add(Component.ChatSerializer.a(ComponentSerializer.toString(page)));
            }
        }

        @Override
        public List<BaseComponent[]> getPages() {
            final List<Component> copy = ImmutableList.copyOf(CraftMetaBook.this.pages);
            return new AbstractList<BaseComponent[]>() {

                @Override
                public BaseComponent[] get(int index) {
                    return ComponentSerializer.parse(Component.ChatSerializer.a(copy.get(index)));
                }
