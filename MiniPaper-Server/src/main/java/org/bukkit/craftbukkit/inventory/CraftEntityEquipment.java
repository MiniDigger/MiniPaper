...
public class CraftEntityEquipment implements EntityEquipment {
    ...
    public void setItemInMainHand(ItemStack item) {
        setEquipment(net.minecraft.world.entity.EquipmentSlot.MAINHAND, item);
    }
    ...
    public void setItemInOffHand(ItemStack item) {
        setEquipment(net.minecraft.world.entity.EquipmentSlot.OFFHAND, item);
    }
    ...
    public void setHelmet(ItemStack helmet) {
        setEquipment(net.minecraft.world.entity.EquipmentSlot.HEAD, helmet);
    }
    ...
    public void setChestplate(ItemStack chestplate) {
        setEquipment(net.minecraft.world.entity.EquipmentSlot.CHEST, chestplate);
    }
    ...
    public void setLeggings(ItemStack leggings) {
        setEquipment(net.minecraft.world.entity.EquipmentSlot.LEGS, leggings);
    }
    ...
    public void setBoots(ItemStack boots) {
        setEquipment(net.minecraft.world.entity.EquipmentSlot.FEET, boots);
    }
    ...
    public void setArmorContents(ItemStack[] items) {
        setEquipment(net.minecraft.world.entity.EquipmentSlot.FEET, items.length >= 1 ? items[0] : null);
        setEquipment(net.minecraft.world.entity.EquipmentSlot.LEGS, items.length >= 2 ? items[1] : null);
        setEquipment(net.minecraft.world.entity.EquipmentSlot.CHEST, items.length >= 3 ? items[2] : null);
        setEquipment(net.minecraft.world.entity.EquipmentSlot.HEAD, items.length >= 4 ? items[3] : null);
    }
    ...
    private void setEquipment(net.minecraft.world.entity.EquipmentSlot slot, ItemStack stack) {
