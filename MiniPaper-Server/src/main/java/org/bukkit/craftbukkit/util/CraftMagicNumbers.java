...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public Material getMaterial(String material, int version) {
        ...
        Dynamic<Tag> converted = DataFixers.getDataFixerOH().update(References.ITEM_STACK, new Dynamic<>(NbtOps.INSTANCE, stack), version, this.getDataVersion());
    ...
    public Advancement loadAdvancement(NamespacedKey key, String advancement) {
        ...
        net.minecraft.advancements.Advancement.SerializedAdvancement nms = (net.minecraft.advancements.Advancement.SerializedAdvancement) GsonHelper.fromJson(ServerAdvancementManager.GSON, advancement, net.minecraft.advancements.Advancement.SerializedAdvancement.class);
        if (nms != null) {
            MinecraftServer.getServer().getAdvancements().advancements.add(Maps.newHashMap(Collections.singletonMap(CraftNamespacedKey.toMinecraft(key), nms)));
