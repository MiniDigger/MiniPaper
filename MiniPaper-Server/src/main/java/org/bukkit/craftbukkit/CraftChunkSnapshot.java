...
public class CraftChunkSnapshot implements ChunkSnapshot {
    ...
    CraftChunkSnapshot(int x, int z, String wname, long wtime, PalettedContainer<BlockState>[] sectionBlockIDs, byte[][] sectionSkyLights, byte[][] sectionEmitLights, boolean[] sectionEmpty, Heightmap hmap, ChunkBiomeContainer biome) {
        this.x = x;
        this.z = z;
