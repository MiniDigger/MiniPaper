...
public abstract class Either<L, R> implements App<Either.Mu<R>, L> {
    ...
    public static final class Instance<R2> implements Applicative<com.mojang.datafixers.util.Either.Mu<R2>, Instance.Mu<R2>>, Traversable<com.mojang.datafixers.util.Either.Mu<R2>, Instance.Mu<R2>>, CocartesianLike<com.mojang.datafixers.util.Either.Mu<R2>, R2, Instance.Mu<R2>> {
