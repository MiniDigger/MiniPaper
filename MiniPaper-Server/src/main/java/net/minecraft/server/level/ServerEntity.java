...
public class ServerEntity {
    ...
    public void sendChanges() {
        ...
        if (!list.equals(this.lastPassengers)) {
            ...
            this.broadcastIncludingSelf(new ClientboundSetPassengersPacket(this.entity)); // CraftBukkit
        }
        ...
        if (this.entity instanceof ItemFrame /*&& this.tickCounter % 10 == 0*/) { // CraftBukkit - Moved below, should always enter this block
            ...
            if (this.tickCount % 10 == 0 && itemstack.getItem() instanceof MapItem) { // CraftBukkit - Moved this.tickCounter % 10 logic here so item frames do not enter the other blocks
                ...
                while (iterator.hasNext()) {
                    ...
                    Packet<?> packet = ((MapItem) itemstack.getItem()).getUpdatePacket(itemstack, (Level) this.level, (net.minecraft.world.entity.player.Player) entityplayer);
        ...
        if (this.tickCount % this.updateInterval == 0 || this.entity.hasImpulse || this.entity.getEntityData().isDirty()) {
            ...
            if (this.entity.isPassenger()) {
                ...
                if (flag) {
                    this.broadcast.accept(new ClientboundMoveEntityPacket.PacketPlayOutEntityLook(this.entity.getId(), (byte) i, (byte) j, this.entity.isOnGround()));
                    this.yRotp = i;
                    this.xRotp = j;
                }
                ...
                if (this.tickCount > 0 || this.entity instanceof AbstractArrow) {
                    ...
                    if (!flag4 && this.teleportDelay <= 400 && !this.wasRiding && this.wasOnGround == this.entity.isOnGround()) {
                        if ((!flag2 || !flag3) && !(this.entity instanceof AbstractArrow)) {
                            if (flag2) {
                                packet1 = new ClientboundMoveEntityPacket.PacketPlayOutRelEntityMove(this.entity.getId(), (short) ((int) k), (short) ((int) l), (short) ((int) i1), this.entity.isOnGround());
                            } else if (flag3) {
                                packet1 = new ClientboundMoveEntityPacket.PacketPlayOutEntityLook(this.entity.getId(), (byte) i, (byte) j, this.entity.isOnGround());
                            }
                        } else {
                            packet1 = new ClientboundMoveEntityPacket.PacketPlayOutRelEntityMoveLook(this.entity.getId(), (short) ((int) k), (short) ((int) l), (short) ((int) i1), (byte) i, (byte) j, this.entity.isOnGround());
                        }
                    } else {
        ...
        if (this.entity.hurtMarked) {
            ...
            if (this.entity instanceof ServerPlayer) {
                ...
                this.entity.level.getServerOH().getPluginManager().callEvent(event);
            ...
            if (!cancelled) {
                this.broadcastIncludingSelf(new ClientboundSetEntityMotionPacket(this.entity));
            }
            // CraftBukkit end
    ...
    public void a(Consumer<Packet<?>> consumer, ServerPlayer entityplayer) { // CraftBukkit - add player
        ...
        this.yHeadRotp = Mth.floor(this.entity.getYHeadRot() * 256.0F / 360.0F);
        consumer.accept(new ClientboundRotateHeadPacket(this.entity, (byte) yHeadRotp));
        // CraftBukkit end
    ...
    private void sendDirtyEntityData() {
        ...
        if (datawatcher.isDirty()) {
            this.broadcastIncludingSelf(new ClientboundSetEntityDataPacket(this.entity.getId(), datawatcher, false));
        }
        ...
        if (this.entity instanceof LivingEntity) {
            ...
            if (!set.isEmpty()) {
                ...
                // CraftBukkit end
                this.broadcastIncludingSelf(new ClientboundUpdateAttributesPacket(this.entity.getId(), set));
            }
