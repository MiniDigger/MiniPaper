...
public class Illusioner extends SpellcasterIllager implements RangedAttackMob {
    ...
    public static AttributeSupplier.Builder eL() {
        return Monster.eS().a(Attributes.MOVEMENT_SPEED, 0.5D).a(Attributes.FOLLOW_RANGE, 18.0D).a(Attributes.MAX_HEALTH, 32.0D);
    }
    ...
    @Override
    protected SoundEvent getSoundCastSpell() {
    ...
    public void performRangedAttack(LivingEntity entityliving, float f) {
        ...
        AbstractArrow entityarrow = ProjectileUtil.getMobArrow(this, itemstack, f);
    ...
    class IllusionerBlindnessSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        public boolean canUse() {
            return !super.canUse() ? false : (Illusioner.this.getTarget() == null ? false : (Illusioner.this.getTarget().getId() == this.lastTargetId ? false : Illusioner.this.level.getDamageScaler(Illusioner.this.blockPosition()).isHarderThan((float) Difficulty.NORMAL.ordinal())));
        }
        ...
        protected void performSpellCasting() {
            Illusioner.this.getTarget().addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 400), org.bukkit.event.entity.EntityPotionEffectEvent.Cause.ATTACK); // CraftBukkit
        }
