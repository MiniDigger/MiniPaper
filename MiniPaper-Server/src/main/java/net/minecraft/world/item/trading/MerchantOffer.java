...
public class MerchantOffer {
    ...
    public MerchantOffer(CompoundTag nbttagcompound) {
        this.rewardExp = true;
        this.xp = 1;
    ...
    private boolean isRequiredItem(ItemStack itemstack, ItemStack itemstack1) {
        if (itemstack1.isEmpty() && itemstack.isEmpty()) {
            ...
            return ItemStack.isSame(itemstack2, itemstack1) && (!itemstack1.hasTag() || itemstack2.hasTag() && NbtUtils.compareNbt(itemstack1.getTag(), itemstack2.getTag(), false));
        }
    }
