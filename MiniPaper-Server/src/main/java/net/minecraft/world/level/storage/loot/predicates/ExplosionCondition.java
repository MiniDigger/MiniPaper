...
public class ExplosionCondition implements LootItemCondition {
    ...
    public boolean test(LootContext loottableinfo) {
        Float ofloat = (Float) loottableinfo.getContextParameter(LootContextParams.EXPLOSION_RADIUS);
    ...
    public static class Serializer implements net.minecraft.world.level.storage.loot.Serializer<ExplosionCondition> {
        ...
        public void serialize(JsonObject jsonobject, ExplosionCondition lootitemconditionsurvivesexplosion, JsonSerializationContext jsonserializationcontext) {}

        @Override
        public ExplosionCondition a(JsonObject jsonobject, JsonDeserializationContext jsondeserializationcontext) {
            return ExplosionCondition.INSTANCE;
        }
    }
}
