...
public class EntitySelectorParser {
    ...
    private MinMaxBounds.FloatRange distance;
    private MinMaxBounds.IntegerRange level;
    @Nullable
    private Double x;
    @Nullable
    private Double y;
    ...
    public EntitySelectorParser(StringReader stringreader, boolean flag) {
        this.distance = MinMaxBounds.FloatRange.e;
        this.level = MinMaxBounds.IntegerRange.e;
    ...
    public EntitySelector getSelector() {
        ...
        if (this.deltaX == null && this.deltaY == null && this.deltaZ == null) {
            if (this.distance.getMax() != null) {
                ...
                axisalignedbb = new AABB((double) (-f), (double) (-f), (double) (-f), (double) (f + 1.0F), (double) (f + 1.0F), (double) (f + 1.0F));
            } else {
                axisalignedbb = null;
            }
        } else {
    ...
    private void finalizePredicates() {
        ...
        if (!this.level.isAny()) {
            this.predicate = this.predicate.and((entity) -> {
                return !(entity instanceof ServerPlayer) ? false : this.level.d(((ServerPlayer) entity).experienceLevel);
            });
        }

    }

    private Predicate<Entity> createRotationPredicate(WrappedMinMaxBounds criterionconditionrange, ToDoubleFunction<Entity> todoublefunction) {
        double d0 = (double) Mth.wrapDegrees(criterionconditionrange.getMin() == null ? 0.0F : criterionconditionrange.getMin());
        double d1 = (double) Mth.wrapDegrees(criterionconditionrange.getMax() == null ? 359.0F : criterionconditionrange.getMax());
    ...
    public MinMaxBounds.FloatRange i() {
        return this.distance;
    }

    public void a(MinMaxBounds.FloatRange criterionconditionvalue_floatrange) {
        this.distance = criterionconditionvalue_floatrange;
    }

    public MinMaxBounds.IntegerRange j() {
        return this.level;
    }

    public void a(MinMaxBounds.IntegerRange criterionconditionvalue_integerrange) {
    ...
    public void setRotX(WrappedMinMaxBounds criterionconditionrange) {
    ...
    public void setRotY(WrappedMinMaxBounds criterionconditionrange) {
